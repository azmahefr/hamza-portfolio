...
const translations = {
    ...
    fr: {
        ...
        about_desc3: "Mon objectif est de devenir un ingénieur logiciel de niveau international qui crée des produits impactants, contribue à des projets open source et aide à construire des technologies qui améliorent la vie des gens. Chaque projet que je développe est une occasion d'apprendre, de grandir et de progresser vers cette vision.",
    ...
    ar: {
        ...
        about_title: "عنّي",
        about_desc1: "أنا حمزة سفاري، طالب في هندسة البرمجيات في جامعة نانجينغ للعلوم والتكنولوجيا (NJUST)، ولدي شغف كبير ببناء برمجيات مبتكرة وحل المشكلات الواقعية باستخدام التكنولوجيا. قبل بدء دراستي الجامعية، أكملت برنامجًا في اللغة الصينية في معهد هاربين للتكنولوجيا، ما عزّز من قدرتي على التكيف وأعدني للعيش في بيئة أكاديمية دولية.",
        about_desc2: "أحب استكشاف هندسة البرمجيات والذكاء الاصطناعي والأمن السيبراني وتطوير الحلول الخلفية والتقنيات السحابية. أؤمن أن التعلم المستمر والانضباط والخبرة العملية هما أساس أن أكون مهندسًا ممتازًا. حصلت على شهادات مثل CS50x من هارفارد، وScientific Computing with Python من freeCodeCamp، وشهادة EF SET C2 في اللغة الإنجليزية، مما يعكس التزامي بتطوير مهاراتي التقنية والاتصالية.",
        about_desc3: "هدفي أن أصبح مهندس برمجيات عالميًا يبتكر منتجات مؤثرة، ويساهم في المشاريع المفتوحة المصدر، ويساعد في بناء تقنيات تُحسّن حياة الناس. كل مشروع أعمل عليه يمثل فرصة للتعلم والنمو والتقدم خطوة أقرب إلى هذا الهدف.",
